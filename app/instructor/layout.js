...
const logout =useLogout()
 ...
 if (showUnauthorized) return <UnauthorizedWarning />;
  ...
  return (
    ...
    <InstructorSidebar isMobileOpen={isMobileOpen} toggleMobileSidebar={toggleMobileSidebar} user={user} loading={loading} />
    ...
    <div className="flex flex-1  flex-col overflow-hidden">
     ...
     {user?.role == 'instructor' && <main className="flex-1 overflow-auto p-6">{children}</main>}
    </div>
  </div>
