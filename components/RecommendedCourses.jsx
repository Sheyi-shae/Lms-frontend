...
export default function RecommendedCourses({courses,loading}) {
      ...
      <>
        {courses.length === 0 && (
          <div className="flex items-center justify-center h-64">
            <p className="text-gray-500 dark:text-gray-300">We couldn't recommend any course for you at the moment</p>
          </div>
        )}
      </>
    )}
