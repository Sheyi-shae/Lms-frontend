...
export default function CoursesByCategory({courses,loading, categoryName}) {
    ...
    <section id="courses" className=" ">
      <div className="container  px-4 mx-auto sm:px-6">
        ...
        courses.map((course, index) => (
          ...
          <>
          <p>No course availble in this category</p>
          </>
          )}
        </motion.div>
        ...
        >
          <Link href={'#'}><Button variant={'outline'}  className={'  outline-emerald-700'} size="lg">
            View All Categories
          </Button></Link>
        </motion.div>
      </div>
