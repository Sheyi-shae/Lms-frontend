...
export default function DeleteAlert({ isDeleteDialogOpen, setIsDeleteDialogOpen, courseId }) {
  ...
  async function handleDeleteCourse(courseId) {
    ...
    try {
      await axios.delete(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/course/${courseId}`, {
    ...
    <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This action cannot be undone. This will permanently delete the course and all associated lessons and materials.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
